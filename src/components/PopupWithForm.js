...
export default class PopupWithForm extends Popup {
    ...
    _getInputValues() {//метод получения данных из input
      ...
      this._inputList.forEach(// добавляем в этот объект значения всех полей
    ...
    updateButtonText(isLoading) {//метод изменения текста на кнопках "создать/сохранить" при загрузке фотографий и информации
